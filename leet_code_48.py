...
Concept make three comprehension as you are not allowed to use the sorted function
Input: nums = [2,0,2,1,1,0]
Output: [0,0,1,1,2,2]
[i for i in nums if i==0]+[i for i in nums if i == 1]+[i for i in nums if i ==2]